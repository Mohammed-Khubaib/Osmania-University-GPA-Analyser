...
if tabs == 'SGPA Calculator':
    ...
    semesters = st.selectbox("Select a semester for which you want to calculate the SGPA",sems)
    sgpa(branch=branch,semesters=semesters)
